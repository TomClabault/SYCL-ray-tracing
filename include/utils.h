...
public:
    ...
    static std::vector<ImageBin> importance_split_skysphere(const Image& skysphere, int minimum_bin_area = 65536, float minimum_bin_radiance = 320000);
    ...
    static void write_env_map_bins_to_file(const std::string& filepath, const std::vector<float>& skysphere_data, const std::vector<ImageBin>& skysphere_importance_bins);
