        ...
        for (int bounce = 0; bounce < MAX_BOUNCES; bounce++)
        {
            if (next_ray_state == BOUNCE)
            {
                ...
                if (intersection_found)
                {
                    ...
                    Ray shadow_ray(Point(closest_hit_info.inter_point), closest_hit_info.normal_at_intersection);
                    ...
                    Vector random_bounce_direction = normalize(Vector(1, 2, 3));
